...
urlpatterns = [
    ...
    path('<int:need>/goals/', views.goal_list_by_need_view, name='goal_list_by_need'),
    path('goal/<int:pk>/', views.goal_detail_view, name='goal_detail'),
    path('step/', views.step_list_view, name='step_list'),
    path('<int:goal>/steps/', views.step_list_by_goal_view, name='step_list_by_goal'),
    path('step/<int:pk>/', views.step_detail_view, name='step_detail'),
    path('iteration/', views.iteration_list_view, name='iteration_list'),
    path('<int:goal>/iteration/', views.iteration_list_by_goal_view, name='iteration_list_by_goal'),
    ...
    path('<int:step>/delivery/', views.delivery_list_by_step_view, name='delivery_list_by_step'),
